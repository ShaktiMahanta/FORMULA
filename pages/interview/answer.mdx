...
1. **Single Responsibility Principle (SRP)**:
   ...
   - **Example**: A class responsible for handling user authentication should not be responsible for handling database operations.
2. **Open/Closed Principle (OCP)**:
   - Software entities (`classes`, `modules`, `functions`, etc.) should be open for extension but closed for modification.
   - **Example**: You can extend the functionality of a class through inheritance or interfaces without modifying the existing code.
3. **Liskov Substitution Principle (LSP)**:
   - Objects of a superclass should be replaceable with objects of a subclass without affecting the correctness of the program.
   - **Example**: If Bird is a superclass and Penguin is a subclass, a Penguin should be able to replace a Bird object without breaking the program.
...
5. **Dependency Inversion Principle (DIP)**:
   ...
   - **Example**: Instead of a class directly instantiating another class, it should depend on an interface that the other class implements.
...
| Null keys/values   | Allows one null value and multiple null values | Does not allow null key or values         |
